function About() {
  return (
    <section id="about" className="min-h-[80vh] scroll-mt-45 py-45">
      <div className="flex mx-10 gap-40 items-center justify-center max-md:flex-col">
        <img
          src="/About-semiformal-no-bg.png"
          alt=""
          className="w-full max-w-lg aspect-square h-auto object-cover object-[50%_30%] grayscale"
        />
        <div>
